...
// data when given a user ID. Write an asynchronous function that 
// fetches and logs the data for each user ID one by one, in
//  sequence.
...
//    success message if the task is successful, and a custom error
